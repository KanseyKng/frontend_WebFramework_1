    ...
    <main className="min-h-screen p-8 bg-gray-100">
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-gray-100">
        <header className="mb-6 border-b pb-4 flex items-center justify-between">
          ...
          <Link href="/">
            <button className="text-sm bg-gray-200 hover:bg-gray-300 text-gray-700 px-3 py-1.5 rounded-md transition">
              Kembali ke Daftar
            </button>
          </Link>
        </header>
        ...
        <div className="space-y-4">
          ...
          {/* Tanggal Dibuat (dari gambar kedua) */}
          <div>
            <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider">
              Tanggal Dibuat
            </label>
